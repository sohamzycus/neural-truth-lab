import {
  ...
  markers_default,
  positionEdgeLabel
} from "./chunk-VRYDINV6.js";
import {
  insertCluster,
  insertNode,
  labelHelper
} from "./chunk-43J5BQHR.js";
import {
  interpolateToCurve
...
var registerDefaultLayoutLoaders = __name(() => {
  registerLayoutLoaders([
    {
      name: "dagre",
      loader: __name(async () => await import("./dagre-VKFMJZFB-XCUAM2UV.js"), "loader")
    },
    {
      name: "swimlane",
      loader: __name(async () => await import("./swimlanes-5IMT3BWC-FDBGJ2YP.js"), "loader")
    },
    ...true ? [
      {
        name: "cose-bilkent",
        loader: __name(async () => await import("./cose-bilkent-JH36ORCC-W62J5KPL.js"), "loader")
      }
    ] : []
  ]);
...
//# sourceMappingURL=chunk-JBGPELRX.js.map

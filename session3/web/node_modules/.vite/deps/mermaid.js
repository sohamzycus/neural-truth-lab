...
} from "./chunk-JBGPELRX.js";
import "./chunk-VRYDINV6.js";
import "./chunk-ZLWDVJFY.js";
import "./chunk-43J5BQHR.js";
import "./chunk-MTHMSS2K.js";
import "./chunk-XFPCCIQ5.js";
import "./chunk-COPWCGZV.js";
import {
  dedent
} from "./chunk-CVDQCVME.js";
import {
  registerIconPacks
} from "./chunk-2RWWUXEG.js";
import {
  cleanAndMerge,
  decodeEntities,
  encodeEntities,
...
import {
  ...
  themes_default,
  updateSiteConfig
} from "./chunk-OANJN7ZQ.js";
import {
  log,
  select_default,
  setLogLevel
} from "./chunk-AA45AWLU.js";
import {
  __name
...
var loader = __name(async () => {
  const { diagram: diagram2 } = await import("./c4Diagram-LMCZKHZV-YLH6ZNPM.js");
...
var loader2 = __name(async () => {
  const { diagram: diagram2 } = await import("./flowDiagram-23GEKE2U-NKWOCO3X.js");
...
var loader4 = __name(async () => {
  const { diagram: diagram2 } = await import("./swimlanesDiagram-G3AALYLV-B2RMZZZZ.js");
...
var loader5 = __name(async () => {
  const { diagram: diagram2 } = await import("./erDiagram-Q63AITRT-M7Q3BXYI.js");
...
var loader6 = __name(async () => {
  const { diagram: diagram2 } = await import("./gitGraphDiagram-IHSO6WYX-LTK2DBSF.js");
...
var loader7 = __name(async () => {
  const { diagram: diagram2 } = await import("./ganttDiagram-NO4QXBWP-IOZSHFKW.js");
...
var loader8 = __name(async () => {
  const { diagram: diagram2 } = await import("./infoDiagram-FWYZ7A6U-QR4KCEXT.js");
...
var loader9 = __name(async () => {
  const { diagram: diagram2 } = await import("./pieDiagram-ENE6RG2P-IU5UXBVX.js");
...
var loader10 = __name(async () => {
  const { diagram: diagram2 } = await import("./quadrantDiagram-ABIIQ3AL-D2C4VEVD.js");
...
var loader11 = __name(async () => {
  const { diagram: diagram2 } = await import("./xychartDiagram-FW5EYKEG-4W26NH7K.js");
...
var loader12 = __name(async () => {
  const { diagram: diagram2 } = await import("./requirementDiagram-TGXJPOKE-EHPWKMBG.js");
...
var loader13 = __name(async () => {
  const { diagram: diagram2 } = await import("./sequenceDiagram-DBY2YBRQ-Z5Z5B5XD.js");
...
var loader14 = __name(async () => {
  const { diagram: diagram2 } = await import("./classDiagram-OUVF2IWQ-C6ZHLRE5.js");
...
var loader15 = __name(async () => {
  const { diagram: diagram2 } = await import("./classDiagram-v2-EOCWNBFH-5ZD63O3Y.js");
...
var loader16 = __name(async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-2N3HPSRC-TEYX3RKC.js");
...
var loader17 = __name(async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-v2-6OUMAXLB-YIP3DKUS.js");
...
var loader18 = __name(async () => {
  const { diagram: diagram2 } = await import("./journeyDiagram-5HDEW3XC-XOFC4NZG.js");
...
var loader20 = __name(async () => {
  const { diagram: diagram2 } = await import("./timeline-definition-FHXFAJF6-R5RYQ2KD.js");
...
var loader21 = __name(async () => {
  const { diagram: diagram2 } = await import("./mindmap-definition-LN4V7U3C-DV2L4QXV.js");
...
var loader22 = __name(async () => {
  const { diagram: diagram2 } = await import("./kanban-definition-HUTT4EX6-QHZQ4PIJ.js");
...
var loader23 = __name(async () => {
  const { diagram: diagram2 } = await import("./sankeyDiagram-HTMAVEWB-LCHNERT3.js");
...
var loader24 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-NH7WQ7WH-PETGF44K.js");
...
var loader25 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-WEI45ONY-6BTIIJD4.js");
...
var loader26 = __name(async () => {
  const { diagram: diagram2 } = await import("./blockDiagram-677ZJIJ3-63IKWJAT.js");
...
var loader27 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-OA4YK3LP-QZ2B6KCJ.js");
...
var loader28 = __name(async () => {
  const { diagram: diagram2 } = await import("./architectureDiagram-ZJ3FMSHR-52HLPGNZ.js");
...
var loader29 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-FQU43EPY-QRA43VMB.js");
...
var loader30 = __name(async () => {
  const { diagram: diagram2 } = await import("./ishikawaDiagram-FXEZZL3T-H3IMZDH2.js");
...
var loader31 = __name(async () => {
  const { diagram: diagram2 } = await import("./vennDiagram-L72KCM5P-3P7KY4H4.js");
...
var loader32 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-G47NLZAW-RMWBVFWP.js");
...
var loader33 = __name(async () => {
  const { diagram: diagram2 } = await import("./wardleyDiagram-EHGQE667-HJDJZ65C.js");
...
var loader34 = __name(async () => {
  const { diagram: diagram2 } = await import("./cynefinDiagram-TSTJHNR4-U5WVIF3X.js");
...
var loader35 = __name(async () => {
  const { diagram: diagram2 } = await import("./railroadDiagram-RFXS5EU6-FGK2K5EE.js");
...
var loader36 = __name(async () => {
  const { diagram: diagram2 } = await import("./ebnfDiagram-CCIWWBDH-GUCWBIAB.js");
...
var loader37 = __name(async () => {
  const { diagram: diagram2 } = await import("./abnfDiagram-VRR7QNED-BZDX37VK.js");
...
var loader38 = __name(async () => {
  const { diagram: diagram2 } = await import("./pegDiagram-2B236MQR-534VW3HX.js");
